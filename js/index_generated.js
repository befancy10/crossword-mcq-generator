!(function (t) {
    ...
    function (t, r, n) {
      ...
      i("showCrossword").onclick = function () {
          //make the showCrossword button disappear
          ...
          if (storedCrosswordData) {
              ...
              // Handle the case where there is no crossword data in sessionStorage
              console.log("No crossword data found in sessionStorage.");
              crosswords = {}; // Initialize as an empty object or handle appropriately
          }
  
          // Ensure crosswords data is stored back in sessionStorage
          // sessionStorage.setItem('crosswordData', JSON.stringify(crosswords));
          ...
          if (crosswords.ownerMap) {
              ...
              i("checkCondition").onclick = function () {
                console.log("Tile count:", tileCount, c);
                if(tileCount == c){
                      ...
                      if (t.data === r.dataset.letter) {
                          ...
                          i("checkCondition").onclick = function () {
                            if (c === 0) {
                              ...
                              var modal = document.getElementById('crosswordNotFinished');
                              var cancelBtn = document.getElementById('okayButtonIncorect');
                              modal.style.display = 'block';
                              cancelBtn.onclick = function () {
                                  modal.style.display = 'none';
                              };
