!(function (t) {
    ...
    function (t, r, n) {
      ...
      i("gen").onclick = function () {
        ...
        if (crosswordGenerated) {
          // Retrieve crossword data from localStorage and parse it
          ...
          if (storedCrosswordData) {
              ...
              // Handle the case where there is no crossword data in localStorage
              console.log("No crossword data found in localStorage.");
              crosswords = {}; // Initialize as an empty object or handle appropriately
          }
  
          // Ensure crosswords data is stored back in localStorage
          // localStorage.setItem('crosswordData', JSON.stringify(crosswords));
